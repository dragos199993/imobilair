...
export const roRO: any = {
  ...
  formFieldLabel__signOutOfOtherSessions:
    'Deconectați-vă de pe toate celelalte dispozitive',
  formFieldLabel__automaticInvitations:
    'Activați invitațiile automate pentru acest domeniu',
  ...
  formFieldLabel__organizationDomainEmailAddress:
    'Adresa de e-mail de verificare',
  ...
  formFieldLabel__organizationDomainDeletePending:
    'Ștergeți invitațiile și sugestiile în așteptare',
  ...
  formFieldError__verificationLinkExpired:
    'Linkul de verificare a expirat. Vă rugăm să solicitați un nou link.',
  ...
  signUp: {
    ...
    emailLink: {
      ...
      formSubtitle:
        'Utilizați link-ul de verificare trimis la adresa dvs. de e-mail',
  ...
  signIn: {
    ...
    resetPassword: {
      ...
      successMessage:
        'Parola dvs. a fost schimbată cu succes. Vă rugăm să așteptați un moment.',
      requiredMessage:
        'Există deja un cont cu o adresă de e-mail neverificată. Vă rugăm să vă resetați parola pentru securitate.',
    },
    resetPasswordMfa: {
      detailsLabel:
        'Trebuie să vă verificăm identitatea înainte de a vă reseta parola.',
    },
    emailCode: {
    ...
    alternativeMethods: {
      ...
      blockButton__emailLink:
        'Trimiteți un link prin e-mail către {{identifier}}',
  ...
  userProfile: {
    ...
    start: {
      ...
      emailAddressesSection: {
        ...
        detailsSubtitle__primary:
          'Această adresă de e-mail este adresa de e-mail principală',
        ...
        detailsSubtitle__unverified:
          'Verificare completă pentru a accesa toate funcțiile cu această adresă de e-mail',
        detailsAction__unverified: 'Verifică adresa de e-mail',
        destructiveActionTitle: 'Eliminați',
        destructiveActionSubtitle:
          'Ștergeți această adresă de e-mail și eliminați-o din contul dvs',
      ...
      phoneNumbersSection: {
        ...
        detailsSubtitle__unverified:
          'Verificare completă pentru a accesa toate funcțiile cu acest număr de telefon',
        detailsAction__unverified: 'Verificați numărul de telefon',
        destructiveActionTitle: 'Eliminați',
        destructiveActionSubtitle:
          'Ștergeți acest număr de telefon și eliminați-l din contul dvs',
      ...
      connectedAccountsSection: {
        ...
        destructiveActionTitle: 'Eliminați',
        destructiveActionSubtitle:
          'Eliminați acest cont conectat din contul dvs',
      ...
      mfaSection: {
        ...
        phoneCode: {
          destructiveActionTitle: 'Eliminați',
          destructiveActionSubtitle:
            'Eliminați acest număr de telefon din metodele de verificare în doi pași',
        ...
        totp: {
          ...
          destructiveActionTitle: 'Eliminați',
          destructiveActionSubtitle:
            'Îndepărtați aplicația de autentificare din metodele de verificare în doi pași',
      ...
      activeDevicesSection: {
        ...
        detailsSubtitle:
          'Acesta este dispozitivul pe care îl utilizați în prezent',
        destructiveActionTitle: 'Deconectați-vă',
        destructiveActionSubtitle:
          'Deconectați-vă din contul dvs. de pe acest dispozitiv',
      ...
      web3WalletsSection: {
        ...
        destructiveActionTitle: 'Eliminați',
        destructiveActionSubtitle:
          'Eliminați acest portofel web3 din contul dvs',
      ...
      dangerSection: {
        ...
        deleteAccountDescription:
          'Ștergeți contul dvs. și toate datele asociate acestuia',
      },
    },
    profilePage: {
    ...
    emailAddressPage: {
      ...
      emailCode: {
        formHint:
          'Un e-mail conținând un cod de verificare va fi trimis la această adresă de e-mail.',
        formTitle: 'Cod de verificare',
        formSubtitle:
      ...
      emailLink: {
        formHint:
          'La această adresă de e-mail va fi trimis un e-mail conținând un link de verificare.',
        formTitle: 'Link de verificare',
        formSubtitle:
          'Faceți clic pe link-ul de verificare din e-mailul trimis către {{identifier}}',
        resendButton: 'Nu ați primit un link? Trimiteți din nou',
        successMessage: 'E-mailul {{identifier}} a fost adăugat în contul dvs.',
      },
      removeResource: {
        ...
        messageLine2:
          'Nu veți mai putea să vă conectați folosind această adresă de e-mail.',
    ...
    phoneNumberPage: {
      ...
      infoText:
        'La acest număr de telefon va fi trimis un mesaj text conținând un link de verificare.',
      infoText__secondary: 'Se pot aplica tarife pentru mesaje și date.',
      removeResource: {
        title: 'Eliminați numărul de telefon',
        messageLine1: '{{identifier}} va fi eliminat din acest cont.',
        messageLine2:
          'Nu veți mai putea să vă conectați folosind acest număr de telefon.',
    ...
    connectedAccountPage: {
      ...
      formHint__noAccounts:
        'Nu există furnizori de conturi externe disponibili.',
    ...
    web3WalletPage: {
      ...
      subtitle__availableWallets:
        'Selectați un portofel web3 pentru a vă conecta la cont.',
      ...
      removeResource: {
        ...
        messageLine1: '{{identifier}} va fi eliminat din acest cont.',
        messageLine2:
          'Nu veți mai putea să vă conectați folosind acest portofel web3.',
        successMessage:
    ...
    mfaTOTPPage: {
      ...
      verifySubtitle:
        'Introduceți codul de verificare generat de autentificatorul dvs',
      successMessage:
      ...
      removeResource: {
        ...
        messageLine1:
          'Codurile de verificare de la acest autentificator nu vor mai fi necesare la autentificare.',
        messageLine2:
          'Este posibil ca contul dumneavoastră să nu fie la fel de sigur. Sunteți sigur că doriți să continuați?',
        successMessage:
          'Verificarea în doi pași prin intermediul aplicației Authenticator a fost eliminată.',
      },
    },
    mfaPhoneCodePage: {
      ...
      removeResource: {
        title: 'Eliminarea verificării în două etape',
        messageLine1:
          '{{identifier}} nu va mai primi coduri de verificare atunci când se conectează.',
        messageLine2:
          'Este posibil ca contul dumneavoastră să nu fie la fel de sigur. Sunteți sigur că doriți să continuați?',
        successMessage:
          'Verificarea în doi pași a codului SMS a fost eliminată pentru {{mfaPhoneCode}}',
      },
    },
    backupCodePage: {
    ...
    deletePage: {
      ...
      actionDescription:
        'Introduceți Delete account (Ștergeți contul) mai jos pentru a continua.',
  ...
  organizationProfile: {
    ...
    verifiedDomainPage: {
      subtitle:
        'Domeniul {{domain}} este acum verificat. Continuați prin selectarea modului de înscriere.',
      start: {
      ...
      enrollmentTab: {
        subtitle:
          'Alegeți modul în care utilizatorii din acest domeniu se pot alătura organizației.',
      ...
      dangerTab: {
        ...
        removeDomainSubtitle:
          'Eliminați acest domeniu din domeniile verificate',
        removeDomainActionLabel__remove: 'Înlăturați domeniul',
        calloutInfoLabel:
          'Eliminarea acestui domeniu va afecta utilizatorii invitați.',
      },
    },
    invitePage: {
    ...
    removeDomainPage: {
      ...
      messageLine2:
        'După aceasta, utilizatorii nu vor mai putea să se alăture automat organizației.',
    ...
    membersPage: {
      ...
      invitationsTab: {
        ...
        manualInvitations: {
          ...
          headerSubtitle:
            'Invitați manual membrii și gestionați invitațiile existente.',
        },
        autoInvitations: {
      ...
      requestsTab: {
        ...
        requests: {
          headerTitle: 'Cereri',
          headerSubtitle:
            'Răsfoiți și gestionați utilizatorii care au solicitat să se alăture organizației.',
        },
        autoSuggestions: {
  ...
  unstable__errors: {
    ...
    phone_number_exists:
      'Acest număr de telefon este ocupat. Vă rugăm să încercați altul.',
    ...
    form_param_format_invalid__email_address:
      'Adresa de e-mail trebuie să fie o adresă de e-mail validă.',
    ...
    form_password_not_strong_enough:
      'Parola dvs. nu este suficient de puternică.',
    ...
    zxcvbn: {
      ...
      warnings: {
        straightRow:
          'Rândurile drepte de taste de pe tastatură sunt ușor de ghicit.',
        keyPattern: 'Modelele scurte de tastatură sunt ușor de ghicit.',
        simpleRepeat:
          'Caracterele repetate, cum ar fi "aaa", sunt ușor de ghicit.',
        extendedRepeat:
          'Modelele de caractere repetate, cum ar fi "abcabcabc", sunt ușor de ghicit.',
        sequences:
          'Secvențele de caractere comune, cum ar fi "abc", sunt ușor de ghicit.',
        ...
        similarToCommon:
          'Acest lucru este similar cu o parolă folosită în mod obișnuit.',
        ...
        pwned:
          'Parola dvs. a fost expusă în urma unei încălcări a securității datelor pe internet.',
      },
      suggestions: {
        ...
        allUppercase:
          'Scrieți cu majuscule unele litere, dar nu toate literele.',
        ...
        anotherWord:
          'Adăugați mai multe cuvinte care sunt mai puțin frecvente.',
        useWords: 'Folosiți mai multe cuvinte, dar evitați frazele comune.',
        noNeed:
          'Puteți crea parole puternice fără a folosi simboluri, numere sau litere majuscule.',
        pwned:
          'Dacă folosiți această parolă în altă parte, ar trebui să o schimbați.',
      },
    },
